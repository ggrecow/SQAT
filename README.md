...
> [!TIP]
> **It is a good practice to cite always the specific SQAT release being used. If you need to cite the current release of SQAT, please refer to the "Cite this repository" feature in the "About" section of this GitHub repository.**
...
Prompted by the lack of well-documented and validated open-source implementations of sound quality (SQ) metrics, the development of SQAT was initiated in 2019 by [Gil Felix Greco](https://www.linkedin.com/in/gil-felix-greco-363985101/) with the main objective of applying it to the SQ analysis of environmental noise generated by virtual aircraft designs. In 2021, a preliminary version of SQAT, which works only with specific inputs provided by an aircraft noise prediction research software (PANAM-DLR), was first applied to analyze the SQ of a novel aircraft concept (see publication below). 
