...
%   
%   - The signals are generated by the <make_AM_fmod.m> function. The 
%     signals are AM tones with different carrier frequencies (md=1 and L=60dB) 
%     as a function of fmod
%
...
% variable s_125hz
fc=125;
s_125hz = il_make_AM_fmod(fc);

% variable s_250hz
fc=250;
s_250hz = il_make_AM_fmod(fc);

% variable s_500hz
fc=500;
s_500hz = il_make_AM_fmod(fc);

% variable s_1khz
fc=1000;
s_1khz = il_make_AM_fmod(fc);

% variable s_2khz
fc=2000;
s_2khz = il_make_AM_fmod(fc);

% variable s_4khz
fc=4000;
s_4khz = il_make_AM_fmod(fc);

% variable s_8khz
fc=8000;
s_8khz = il_make_AM_fmod(fc);
