...
The `Tonality_ECMA418_2_software_comparison.m` code compares tonality results (ECMA-418-2 model [1]) obtained in a commercial software and using the implementation in SQAT (see `Tonality_ECMA418_2.m` code [here](../../../psychoacoustic_metrics/Tonality_ECMA418_2/Tonality_ECMA418_2.m)). To perform this study, a binaural file recorded in a 'train station' environment is used. The signal 'TrainStation.7.wav' was extracted from the EigenScape database [(link)](https://zenodo.org/doi/10.5281/zenodo.1012808), and trimmed between 01m00s and 01m30s. The EigenScape database, which is described by 
