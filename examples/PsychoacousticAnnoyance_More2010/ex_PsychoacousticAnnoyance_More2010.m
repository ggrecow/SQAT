...
res = PsychoacousticAnnoyance_More2011(ycal, fs,... % input signal and sampling freq.
...
PA = PsychoacousticAnnoyance_More2011_from_percentile(res.L.N5,...   % loudness percentile
