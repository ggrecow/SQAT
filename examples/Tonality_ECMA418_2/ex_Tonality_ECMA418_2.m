...
%
% Example: compute Tonality (ECMA 418-2:2024) of reference (mono) signal 
% and exemplary stereo signal.
% 
% Reference signal: pure tone with center frequency of 1 kHz and RMS value of 40 dBSPL equals 1 tu_HMS
% - The signal is stored in the following folder: <sound_files\reference_signals\>. 
% - Signal label: <RefSignal_Tonality_ECMA418_2.wav>
%
...
mono_signal_label = 'RefSignal_Tonality_ECMA418_2.wav';
...
OUT_mono = Tonality_ECMA418_2(ref_signal.signal, ref_signal.fs, fieldtype, time_skip, show);
                 
fprintf('\nTonality (ECMA-418-2:2024 - Hearing Model of Sottek): \n');
fprintf('\t- Reference signal  (1-kHz pure tone with 40 dBSPL)\n');
fprintf('\t- Overall tonality value: %g (tu).\n',OUT_mono.tonalityAvg);
...
OUT_stereo = Tonality_ECMA418_2(stereo_signal.signal, stereo_signal.fs, fieldtype, time_skip, show);
         
fprintf('\nTonality (ECMA-418-2:2024 - Hearing Model of Sottek): \n');
fprintf('\t- Stereo signal: %s\n', stereo_signal_label );
fprintf('\t- Overall tonality value (channel 1):  %g (tu).\n', OUT_stereo.tonalityAvg(1) );
fprintf('\t- Overall tonality value (channel 2):  %g (tu).\n' ,OUT_stereo.tonalityAvg(2) );
