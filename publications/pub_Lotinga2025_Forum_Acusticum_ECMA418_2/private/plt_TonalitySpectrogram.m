function plt_TonalitySpectrogram(x1Axis, y1Axis, z1Axis, x2Axis, y2Axis, z2Axis, save_figs,  label_fig)
% function plt_TonalitySpectrogram(x1Axis, y1Axis, z1Axis, x2Axis, y2Axis, z2Axis, save_figs,  label_fig)
%
% Generates the following plot:
% Time-dependent specific tonality (channel 1)
%
...
xx(:,end) = 30;  % truncating last idx of time to 30s (just a visual thing because ref results are almost 30s)
pcolor(xx, yy, z1Axis);
